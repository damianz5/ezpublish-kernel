...
class ContentServiceTest extends BaseContentServiceTest
{
     ...
     */
    public function testDeleteTranslationThrowsBadStateExceptionOnSingleTranslation()
    {
        $repository = $this->getRepository();
        $contentService = $repository->getContentService();
        ...
        $contentService->deleteTranslation($draft->versionInfo, 'eng-US');
    }
     ...
     * @expectedExceptionMessage Specified Translation is the main Translation of the Content Object
     */
    public function testDeleteTranslationThrowsBadStateExceptionOnMainTranslation()
    {
        $repository = $this->getRepository();
        $contentService = $repository->getContentService();
        ...
        $contentService->deleteTranslation($draft->versionInfo, $mainLanguageCode);
    }
     ...
     */
    public function testDeleteTranslationThrowsBadStateExceptionOnPublishedVersion()
    {
        $repository = $this->getRepository();
        $contentService = $repository->getContentService();
        ...
        $contentService->deleteTranslation($publishedContent->versionInfo, $languageCode);
    }
    ...
    public function testDeleteTranslationThrowsUnauthorizedException()
    {
        ...
        $contentService->deleteTranslation($draft->versionInfo, $languageCode);
    }
